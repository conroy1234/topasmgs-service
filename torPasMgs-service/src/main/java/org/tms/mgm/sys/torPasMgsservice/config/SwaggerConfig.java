package org.tms.mgm.sys.torPasMgsservice.config;
...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Conroy White", "conroyTest@torpastes.com", "07036525436");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(" application to moniter tore pass", " Api Documentation", "1.0",
